...
namespace ORB_SLAM3_Wrapper
{
    RgbSlamNode::RgbSlamNode(const std::string &strVocFile,
        ...
        : Node("ORB_SLAM3_RGB_ROS2")
    {
        // ROS Subscribers
        rgb_sub = std::make_shared<message_filters::Subscriber<sensor_msgs::msg::Image>>(this, "camera/image_raw");
        imu_sub = this->create_subscription<sensor_msgs::msg::Imu>("imu", 1000, std::bind(&RgbSlamNode::ImuCallback, this, std::placeholders::_1));
        odom_sub = this->create_subscription<nav_msgs::msg::Odometry>("odom", 1000, std::bind(&RgbSlamNode::OdomCallback, this, std::placeholders::_1));
        // ROS Publishers
        ...
        // Services
        get_map_data_service = this->create_service<slam_msgs::srv::GetMap>("orb_slam3_get_map_data", std::bind(&RgbSlamNode::getMapServer, this,
    ...
    {
        Sophus::SE3f Tcw;
        if (interface->trackRGB(msgRGB, Tcw))
        {
